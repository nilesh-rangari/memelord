...
import LogoImage from '../assets/memelord image.png'
...
export default function Home() {
    return(
        <div className='bg-gradient-to-br from-black to-red-900 h-screen'>
            ...
            <section 
                className="min-h-screen flex items-center justify-center flex-col sm:flex-row text-center py-10 pt-24" 
                id="section_home"
            >
                ...
                <div className='flex flex-col justify-center items-center'>
                    ...
                    <p className="text-2xl text-white my-4 md:my-10 w-[75%] md:w-[54ch]">
